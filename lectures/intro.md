...
(Note that idiomatic Haskell uses `camelCase` for identifier names. If
...
As you would expect, Boolean values can be combined with `(&&)` (logical
...
Haskell (like Python) also has *list comprehensions*; you can read about
